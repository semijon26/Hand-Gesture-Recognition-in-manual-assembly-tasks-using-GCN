...
class TTA:
    ...
    def test_time_augmentation(self, image):
        ...
        landmarks_sliding_input = torch.from_numpy(self.landmarks_sliding[None, :, :]).float()
...
model.eval()
MODEL_PATH = os.path.join(curr_dir,
                          "trained_models/3_AAGCN_Focal_seqlen32_release_SAM_joints1_joints2_ori/f10.8439268867924529_valloss246.87600708007812_epoch12.pth")
...
while cap.isOpened():
    ...
    for n, c in NUM2CLASSES_EN.items():
        ...
        pil_image = progressBar(pil_image, (0, 0, 0), (0, 255, 0), offleft - 40, offtop + n * 30 + 7, 200, 10,
                                probas[0, n])
