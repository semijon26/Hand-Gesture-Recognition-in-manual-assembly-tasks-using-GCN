...
def train_eval():
    model_1.load_state_dict(torch.load(MODEL_PATH_1, map_location=device)["model_state_dict"])
    model_2.load_state_dict(torch.load(MODEL_PATH_2, map_location=device)["model_state_dict"])
